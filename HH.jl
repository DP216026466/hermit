...
# ╔═╡ 4b224e29-183e-4c40-83eb-1070b0bdab8f
using Markdown

# ╔═╡ ed646896-ebdf-4357-8b4f-522e2da04320
 using DataFrames, Plots, Statistics,XLSX

# ╔═╡ 315a5bc7-5227-4fbd-9d2f-a6b843dfac4d
using PlutoUI

# ╔═╡ dfd3d8d9-40c6-4ad6-8fa5-002bf468f33b
df = DataFrame(XLSX.readtable("C:/Users/DPilemoni/Documents/Data Science 25/TAM/Assignment/Household.xlsx", "Sheet1"))

# ╔═╡ 47eaf418-ea11-43ec-98da-5920a68989bf
    # Create plot
    p = scatter(df.TotalWaste, df.HouseholdWaste, 
        label="Actual Data", 
        xlabel="Total Waste (tons)", 
        ylabel="Household Waste",
        title="TotalWaste VS HouseholdWaste",
        legend=:topleft)

# ╔═╡ d7cd029a-68c0-4d1b-a56b-7c832628bc54
...
manifest_format = "2.0"
project_hash = "69307057c9c3b53df1ab5c277b0e054d293a3f40"
